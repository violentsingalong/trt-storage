...
| Gereropharm in 25.6 well | 1.73 diametral / 0.865 radial clearance | ACCEPTED_NO_LINER | User accepts direct fit; dedicated Gereropharm liner development closed as unnecessary |
| Gereropharm liner G3 V3, 24.4 ID / 25.3 OD | 0.45 radial wall / 0.30 well clearance | ARCHIVED_TEST_ARTIFACT | Superseded by accepted direct vial fit; retained only as development history |
