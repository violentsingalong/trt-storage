...
vertical_liner_outer_d = 25.40; // PROVISIONAL split collar; 0.20 mm diametral clearance
vertical_liner_clearance = vertical_vial_cavity_d - vertical_liner_outer_d;
gereropharm_liner_ids = [24.0, 24.2, 24.4];
kosa_liner_ids = [22.4, 22.6, 22.8];
