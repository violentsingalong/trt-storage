.PHONY: image coupon magnet-coupon vertical-coupon liner-coupon liner-coupon-v2 liner-g3-v3 fuzzy-coupons check check-magnet check-vertical check-liners check-liners-v2 check-liner-g3-v3 check-fuzzy check-all clean
...
check-all: check check-magnet check-vertical check-liners check-liners-v2 check-liner-g3-v3 check-fuzzy

clean:
	rm -f $(VIAL_STL) $(MAGNET_STL) $(VERTICAL_STL) $(LINER_STL) $(LINER_V2_STL) $(LINER_G3_V3_STL) $(FUZZY_STLS)
